...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = Conv2dLSQ(inplanes, planes, kernel_size=1, bias=False, nbits=nbits)
        self.bn1 = nn.BatchNorm2d(planes)
        #self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.conv2 = Conv2dLSQ(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False, nbits=nbits)
        self.bn2 = nn.BatchNorm2d(planes)
        #self.conv3 = nn.Conv2d(planes, planes * 4, kernel_size=1, bias=False)
        self.conv3 = Conv2dLSQ(planes, planes * 4, kernel_size=1, bias=False, nbits=nbits)
