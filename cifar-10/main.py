...
def main():
    ...
    if args.evaluate:
        ...
        if os.path.isfile(checkpoint_file):
            ...
            args.start_epoch = 150#checkpoint['epoch'] - 1
    ...
    if args.evaluate:
        l, t1, t5 = validate(val_loader, model, criterion, 0)
        print('Loss:', l, '; top1 =', t1, '; top5 =', t5)
        return
